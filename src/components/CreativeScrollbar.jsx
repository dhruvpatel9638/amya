...
export default function CreativeScrollbar({ activeSection, onNavigate }) {
  ...
  return (
    <>
      ...
      <div
        className="fixed top-0 left-0 right-0 h-[2.5px] z-[60] pointer-events-none bg-gradient-to-r from-[#3F7E7C] via-[#5fa2a0] to-[#2b2b2b] origin-left transition-transform duration-75"
      ...
      <div
        ...
        className="fixed right-0 top-16 sm:top-0 bottom-6 sm:bottom-0 z-50 w-3.5 sm:w-6 hover:w-9 select-none cursor-pointer flex justify-end transition-all duration-300 pointer-events-auto group"
      ...
      >
        ...
        <div className="absolute right-1 sm:right-2 top-0 bottom-0 w-[1.5px] bg-[#dedede] group-hover:bg-[#cfcfcf] transition-colors pointer-events-none" />

        {/* Active Glowing Gradient Progress Rail */}
        <div
          className="absolute right-1 sm:right-2 top-0 w-[2.5px] bg-gradient-to-b from-[#3F7E7C] via-[#5fa2a0] to-[#3F7E7C] rounded-full pointer-events-none transition-all duration-75"
          ...
          <AnimatePresence>
            {showBadge && (
              <motion.div
                ...
                className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#2b2b2b] text-white shadow-xl backdrop-blur-md border border-white/10 pointer-events-none whitespace-nowrap mr-1"
              >
          ...
          <div
            className={`rounded-full transition-all duration-200 flex flex-col items-center justify-center shadow-md cursor-grab active:cursor-grabbing ${
              isDragging
                ...
                : 'w-2 sm:w-2.5 group-hover:w-3 h-9 sm:h-11 bg-[#2b2b2b] group-hover:bg-[#3F7E7C]'
            }`}
          >
            {/* Subtle Grip Line inside thumb */}
            <div className="w-0.5 sm:w-1 h-2.5 sm:h-3 rounded-full bg-white/70" />
          </div>
        </div>
      </div>
    </>
